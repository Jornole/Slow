...
# -------------------------------------------------------------
# GLOBAL CSS  (V39: radio buttons evenly spaced)
# -------------------------------------------------------------
st.markdown("""
<style>
...
/* ---- V39 FIX: Spread radio buttons evenly across full width ---- */
.stRadio > div {
...
# VERSION NUMBER
# -------------------------------------------------------------
st.markdown("<div style='font-size:0.8rem; margin-top:20px;'>Version v39</div>", unsafe_allow_html=True)