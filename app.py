...
# -------------------------------------------------------------
# GLOBAL STYLING – baggrund, knapper, tekst
# -------------------------------------------------------------
st.markdown("""
<style>
...
# -------------------------------------------------------------
# HEADER layout – logo til venstre og tekst til højre
# -------------------------------------------------------------
